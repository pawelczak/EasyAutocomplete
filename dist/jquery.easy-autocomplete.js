 ...
 * Copyright  License:
 * 20180603
 * Updated and patched for incremental data append
		...
		function prepareField() {
			...
			function createContainer() {
              ...
              console.log('Number of to-be loaded records: ' + listBuilders[0].data.length);
                ...
                //console.log($elements_container);
                config.get("list").onLoadEvent();

              }else{
                console.log('Disabing scrolling!');
                scroll_enabled = false;
              }
              console.log('Scrolling after: ' + scroll_enabled);

              console.log('Setting to_append false end loadelements-');
              to_append = false;
